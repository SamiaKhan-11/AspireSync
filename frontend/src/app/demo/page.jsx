  ...
  return (
    <div className='bg-white p-1 h-fit'>
      ...
      <div className="relative z-10 my-12 max-w-screen-lg border px-4 py-8 bg-white shadow-2xl shadow-black sm:mx-4 sm:rounded-xl md:mx-auto">
        <form onSubmit={companyform.handleSubmit} className='space'>
          {/* Form Header */}
          <div className="text-center border-b py-4 sm:flex-row sm:items-start">
            <h1 className="font-bold text-4xl mb-3 text-black underline underline-offset-4 [text-shadow:3px_5px_2px_#c2bcc4]">Add Company Information</h1></div>
          {/* Form Fields */}
          ...
          <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
            <label className="shrink-0 w-32 font-bold bg-blue-300 rounded-tr-full rounded-br-full text-center mt-2  shadow-black shadow-inner">Website</label>
            <input
              type="url"
              id="website"
          ...
          <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
            <label className="shrink-0 w-32 font-bold bg-blue-300 rounded-tr-full rounded-br-full text-center mt-2 shadow-black shadow-inner">Description</label>
            <textarea
              id="description"
          ...
          <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
            <label className="shrink-0 w-32 font-bold bg-blue-300 rounded-tr-full rounded-br-full text-center mt-2 shadow-black shadow-inner">Contact Email</label>
            <input
              type="email"
              id="contactEmail"
